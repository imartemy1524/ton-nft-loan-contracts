...
export const LoanStatusLabels: Record<LoanStatus, string> = {
    [LoanStatus.NOT_INITIALIZED]: 'Not Initialized',
    [LoanStatus.NOT_REPAYED]: 'Not Repaid',
    [LoanStatus.REPAYED]: 'Repaid',
    [LoanStatus.IN_PROGRESS]: 'In Progress',
    [LoanStatus.WAITING_FOR_FUNDS]: 'Waiting for Funds',
    [LoanStatus.CANCELLED]: 'Cancelled',
};

export const LoanStatusColors: Record<LoanStatus, string> = {
    [LoanStatus.NOT_INITIALIZED]: 'text-gray-400',
    [LoanStatus.NOT_REPAYED]: 'text-red-400',
    [LoanStatus.REPAYED]: 'text-green-400',
    [LoanStatus.IN_PROGRESS]: 'text-blue-400',
    [LoanStatus.WAITING_FOR_FUNDS]: 'text-yellow-400',
    [LoanStatus.CANCELLED]: 'text-gray-500',
};
